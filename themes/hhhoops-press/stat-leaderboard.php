...
$headerbg = 'http://hypeherhoopscircuit.com/wp-content/uploads/2022/12/Background-site-newsizw.png'; 
...
<div class="grid-container">
  <div class="full_width_container small-12 medium-12 large-12">
  ...
  <?php 
    switch( $pg_type ){
      case '':
      case 'all-events':
      case 'event': hhh_dir_render('stat-leaderboard','by-event', '', $arg = null); break;
    }
  ?>
