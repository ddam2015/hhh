 ...
 */
class ProductByCategoryBlockhhhoops extends Component {
	static propTypes = {
		/**
...
export default withSpokenMessages( ProductByCategoryBlockhhhoops );
