...
var hhhoops_reveal_closer_today_button = $('#reveal_close_today');
if (hhhoops_reveal_closer_today_button.length > 0) {
  hhhoops_reveal_closer_today_button.on('click', function() {
    localStorage.setItem("hhhoops_close_today", 'true');
    localStorage.setItem("hhhoops_close_today_date", new Date() );
  });
}
...
$(function() {
    if(document.querySelector('.hbspt-form')) {
        console.log('hubspot form detected');
...
var guidelinesSubmenu = $('.stats-menu ul');

$('#main-nav li').hover(function(e) {
  console.log(e.currentTarget);
  if(e.currentTarget.textContent == 'Tournament Guidelines') {
    guidelinesSubmenu.css('display','block');
  } else {
    guidelinesSubmenu.css('display','none');
  }
})
